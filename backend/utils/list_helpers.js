...
const totalLikes = (blogs) => {
  const reducer = (accumlator,current_value) => accumlator + current_value.likes
...
const favoriteBlog = (blogs) => {
  ...
  const reducer = (blog_most_likes,current_blog) =>  current_blog.likes > blog_most_likes.likes ? current_blog : blog_most_likes
...
const mostBlogs = (blogs) => {
  ...
  const mapper = (value,key) => {return {"author":key,"blogs":value};}
...
const mostLikes = (blogs) => {  
    ...
    const mapper = (value,key) => {return {"author":key,"likes":value.reduce(vred,0)}}
